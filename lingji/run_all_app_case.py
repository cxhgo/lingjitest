...
if __name__ == "__main__":
    ...
    # 邮箱配置
    sender = "w294350757@163.com"
    psw = "Wsz13975943593"
    smtp_server = "smtp.163.com"
    port = 465
    receiver = ["294350757@qq.com","guozhi@linghit.com","suquanmin@linghit.com","wushanzhang@linghit.com"]
    with open("F:\\untitled\\report\\result.html", "r", encoding="utf-8") as fp:
        f = fp.read()
